...
const loader = new DataLoader(async (keys) => {
    ...
    const [status, data] = await bookshelfService.GetManyByIds(keys)
    if (status !== 200) throw new ApolloError('something happened when trying to get bookshelf from loader')
